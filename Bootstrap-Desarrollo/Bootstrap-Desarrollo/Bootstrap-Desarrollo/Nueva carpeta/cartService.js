function getCarts() {
    ...
    // Simulamos una lista de carritos con reqres.in o puedes cambiar a la Fake Store API real
...
function viewCartDetail(cartId) {
    // Puedes cambiar esta URL por la Fake Store API real si decides integrarla.
